...
if (calBtn) {
  calBtn.addEventListener('click', e => {
    ...
    const ics = [
      ...
      'SUMMARY:Omar & Salma Wedding',
      'LOCATION:Nile Royal Garden, Cairo',
      'DESCRIPTION:You are invited to celebrate the wedding of Omar & Salma.',
      'END:VEVENT',
      'END:VCALENDAR'
    ].join('\r\n');
    ...
    link.download = 'omar-salma-wedding.ics';
    link.click();
...
if (calBtn) {
  calBtn.addEventListener('click', e => {
    ...
    const ics = [
      ...
      'BEGIN:VEVENT',
      'DTSTART:20270615T180000',
      'DTEND:20270616T010000',
      'SUMMARY:Ahmed & Esraa Wedding',
      'LOCATION:The Gabriel Hotel, Cairo',
